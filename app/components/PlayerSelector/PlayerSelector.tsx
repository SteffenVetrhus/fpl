  ...
  return (
    <div className="mb-6">
      ...
      <select
        ...
        className="w-full px-4 py-2.5 border border-gray-200 rounded-full bg-white text-gray-900 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      >
        {managers.length === 0 ? (
